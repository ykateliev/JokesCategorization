...
namespace JokesCategorizationML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\yane\source\repos\JokesCategorization\JokesCategorizationBG\bin\Debug\netcoreapp3.0\data.csv";
        private static string MODEL_FILEPATH = @"../../../../JokesCategorizationML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.LightGbm(labelColumnName: "category", featureColumnName: "Features")
